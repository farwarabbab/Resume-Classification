...
for doc_file in upload_file:
    if doc_file is not None:
        ...
        all_skills.extend(extracted_skills)  # Append extracted skills to all_skills list
        skills.append(extracted_skills)
        file_type = file_type.append({'Uploaded File': doc_file.name, 'Predicted Profile': prediction, 'Skills': extracted_skills}, ignore_index=True)
